...
```{r, fig.cap="The decision of numerous individual agents can result in the emergence of phenomena at the population, community, or landscape scale.", out.width="80%", echo=FALSE}
