...
```{r, fig.cap="Agent-based model outputs integrate the behavioral decisions of individual organisms to generate insights about populations, communities, and ecosystems.", out.width="50%", echo=FALSE}
knitr::include_graphics("images/abm.png")
```
...
```{r, fig.cap="The decision of numerous individual agents can result in the emergence of phenomena at the population, community, or landscape scale.", out.width="50%", echo=FALSE}
knitr::include_graphics("images/emergent_behaviors.png")
```
