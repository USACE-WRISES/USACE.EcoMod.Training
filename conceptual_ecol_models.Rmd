...
![*Conceptual model of the New York Bight ecosystem designed for ecosystem management and restoration projects in the estuary (Durham and McKay).*](CEM/fig1.png){width=70%}  
...
![*Conceptual model of submerged aquatic vegetation in Chesapeake Bay (Kemp et al. 2004).*](CEM/fig2.png){width=40%} 
...
![*Five teams from USACE Ecosystem restoration classes in 2018*](CEM/fig3.png){width=80%} 
...
![*Three conceptual models of stream impacts*](CEM/fig4.png){width=80%} 
...
![*Important axes for determining the form of a conceptual ecological model*](CEM/fig5.png){width=80%} 
...
Figure 6
![*Sediment release model designed for Tuttle Creek Reservoir, Kansas, which indicates omitted variables*](CEM/fig6.png){width=80%} 
