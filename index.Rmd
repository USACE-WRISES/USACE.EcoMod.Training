...
* Pre-requisites: Some familiarity with ecological models and how they are used in USACE. Experience with numerical modeling, coding, and data analysis may be useful but not required.

## Learning objectives {-}
* Become familiar with R coding basics, the RStudio environment, and the benefits of using these tools for conducting analyses.
...
## Module format {-}
Asynchronous, self-directed video modules loaded to Youtube, accompanied by written walkthroughs and R scripts. This format was selected because it is:
* Durable (i.e., videos/tutorials persist online)
* Flexible for learners
* Has potential impact beyond USACE

## Module structure {-}
* Background with slides for context (5-10 minutes)
