...
**This module will teach you how to use linear models in R to assess relationships among environmental factors in a USACE-managed Upper Mississippi River.**

*Acknowledgements:
Some inspiration/language/code have been used or adapted with permission from:
